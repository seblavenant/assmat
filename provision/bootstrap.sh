...
cp /vagrant/provision/apache2/virtualhost.conf /etc/apache2/sites-enabled/
...
sh /vagrant/provision/apache2/xdebug.sh
...
# CONFIG USER
cp /vagrant/provision/home/.bashrc /home/vagrant/
cp /vagrant/provision/home/.gitconfig /home/vagrant/
cp /vagrant/provision/home/.vimrc /home/vagrant/
...
cp /vagrant/provision/scripts/wkhtmltopdf.sh /usr/local/bin/
